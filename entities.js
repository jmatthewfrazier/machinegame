...
Box1.prototype.update = function () {
    ...
    for (var i = 0; i < this.game.boxes.length; i++) {
      ...
      if(this.boundingbox.collide(box.boundingbox) && box !== this){
        collisions++;
      }
      if (this.boundingbox.collide(box.boundingbox) && !(box instanceof Box1)
        && !(box instanceof Lightning) && !(box instanceof Lever)
        && !(box instanceof Character) && !(box instanceof Plat3)
        && !(box instanceof Plate) && !(box instanceof Plat1)) {
          this.pushedRight = false;
          this.blocked = true;
        ...
        if (box.rightMove) {
            ...
            this.speed = -box.speed;
            this.x += this.speed * this.game.clockTick;
            this.boundingbox.x += this.speed * this.game.clockTick;
        }
      }
    }
    if (collisions == 0) {
...
Box2.prototype.update = function () {
    for (var i = 0; i < this.game.boxes.length; i++) {
        ...
        if (box instanceof Box2 && this.x === box.x && this.y > box.y) {
            this.stacked = true;
        } else if (this.boundingbox.collide(box.boundingbox) && (box instanceof Plat1 || box instanceof Plat3)) {
          if (box.rightMove) {
...
Unicorn.prototype.update = function () {
  ...
  ydelta = this.y;
    ...
    if (this.game.running) {
      ...
      if (this.jumping && this.justRight) {
          ...
          if (duration > this.jumpAnimation.totalTime / 8) {
          ...
          for (var i = 0; i < this.game.boxes.length; i++) {
              var box = this.game.boxes[i];
              if (this.jumpAnimation.currentFrame() > 7){
      ...
      //   var box = this.game.entities[i];
      //   console.log(box);
      //   if (box.boundingbox && this.boundingbox.collide(box.boundingbox) && this.boundingbox.bottom >= box.boundingbox.top && box instanceof Box1) {
      //     if (box.onPlat) {
      //       this.x += box.speed * this.game.clockTick;
      //     }
      //   }
      ...
      if (this.jumping && this.justLeft) {
        console.log("jumping left");
          ...
          if (duration > this.jumpRevAnimation.totalTime / 8) {
  ...
  if (this.falling) {
      ...
      for (var i = 0; i < this.game.boxes.length; i++) {
          ...
          // else if (this.boundingbox.collide(box.boundingbox) && box === this.platform && this.lastbottom <= box.boundingbox.top) {
          //   this.falling = false;
          //   this.onBox = true;
          //   this.platform = box;
          //   // console.log("892");
  ...
  if (this.rightMove) {
      ...
      for (var i = 0; i < this.game.boxes.length; i++) {
          ...
          // if(this.boundingbox.collide(box.boundingbox) && this.boundingbox.left < box.boundingbox.left && this.boundingbox.right >= box.boundingbox.left && (box instanceof Plat3)) {
          //   this.speed = 130;
          //   console.log("stuck");
          // }
      ...
      for (var i = 0; i < this.game.boxes.length; i++) {
          ...
          if (this.onBox && this.boundingbox.collide(box.boundingbox) && this.x < box.x && !(box instanceof Plat1) && !(box instanceof Plat2) && !(box instanceof Lightning) && !(box instanceof Plate) && !(box instanceof Lever)  && !(box instanceof Character) && !(box instanceof Plat3)) {
      ...
      for (var i = 0; i < this.game.boxes.length; i++) {
          var box = this.game.boxes[i];
          if (this.boundingbox.collide(box.boundingbox) && this.lastbottom <= box.boundingbox.top && !(box instanceof Character)) {
              this.jumping = false;
              // collisions++;
              this.y = box.boundingbox.top - this.animation.frameHeight;
              this.jumpAnimation.elapsedTime = 0;
  ...
  if (this.onBox) {
      this.y = this.platform.boundingbox.top - this.boundingbox.height - 7;
